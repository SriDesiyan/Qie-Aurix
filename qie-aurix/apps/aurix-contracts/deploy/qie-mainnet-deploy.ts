...
async function main() {
  ...
  console.log("Starting Production QIE Blockchain Mainnet V3 Deployment...");
  ...
  if (qieDomainsAddress) {
    console.log("QIE Domains Address: ", qieDomainsAddress);
  }
  ...
  console.log("\n✅ All QIE Aurix contracts successfully deployed to QIE Mainnet V3!");
}
