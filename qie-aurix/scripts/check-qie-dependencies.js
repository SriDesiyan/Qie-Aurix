...
async function checkExplorer(url) {
  try {
...
async function checkContract(rpcUrl, address) {
...
- **QIE Pass Address**: \`${QIE_PASS_ADDRESS}\`
  ...
  - Detail: ${qiePassStatus.error || "Placeholder or missing address"}
...
- **QIE Domains Address**: \`${QIE_DOMAINS_ADDRESS}\`
  ...
  - Detail: ${qieDomainsStatus.error || "Placeholder or missing address"}
